classdef ConfigLatticeVelocitySet < robotics.ros.Message
    %ConfigLatticeVelocitySet MATLAB implementation of runtime_manager/ConfigLatticeVelocitySet
    ...
    properties (Constant)
        MessageType = 'runtime_manager/ConfigLatticeVelocitySet' % The ROS message type
    end
    ...
    methods
        function obj = ConfigLatticeVelocitySet(msg)
            %ConfigLatticeVelocitySet Construct the message object ConfigLatticeVelocitySet
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'Header');
        ...
        function set.OthersDistance(obj, othersdistance)
            ...
            validateattributes(othersdistance, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'OthersDistance');
        ...
        function set.DetectionRange(obj, detectionrange)
            ...
            validateattributes(detectionrange, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'DetectionRange');
        ...
        function set.ThresholdPoints(obj, thresholdpoints)
            ...
            validateattributes(thresholdpoints, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'ThresholdPoints');
        ...
        function set.DetectionHeightTop(obj, detectionheighttop)
            ...
            validateattributes(detectionheighttop, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'DetectionHeightTop');
        ...
        function set.DetectionHeightBottom(obj, detectionheightbottom)
            ...
            validateattributes(detectionheightbottom, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'DetectionHeightBottom');
        ...
        function set.Deceleration(obj, deceleration)
            ...
            validateattributes(deceleration, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'Deceleration');
        ...
        function set.VelocityChangeLimit(obj, velocitychangelimit)
            ...
            validateattributes(velocitychangelimit, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'VelocityChangeLimit');
        ...
        function set.DecelerationRange(obj, decelerationrange)
            ...
            validateattributes(decelerationrange, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'DecelerationRange');
        ...
        function set.TemporalWaypointsSize(obj, temporalwaypointssize)
            ...
            validateattributes(temporalwaypointssize, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigLatticeVelocitySet', 'TemporalWaypointsSize');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.runtime_manager.ConfigLatticeVelocitySet.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.runtime_manager.ConfigLatticeVelocitySet;
            obj.reload(strObj);
        end
    end
end
