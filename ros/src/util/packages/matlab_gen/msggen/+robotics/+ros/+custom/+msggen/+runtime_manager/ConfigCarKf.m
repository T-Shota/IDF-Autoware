classdef ConfigCarKf < robotics.ros.Message
    %ConfigCarKf MATLAB implementation of runtime_manager/ConfigCarKf
    ...
    properties (Constant)
        MessageType = 'runtime_manager/ConfigCarKf' % The ROS message type
    end
    ...
    methods
        function obj = ConfigCarKf(msg)
            %ConfigCarKf Construct the message object ConfigCarKf
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ConfigCarKf', 'Header');
        ...
        function set.InitialLifespan(obj, initiallifespan)
            ...
            validateattributes(initiallifespan, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigCarKf', 'InitialLifespan');
        ...
        function set.DefaultLifespan(obj, defaultlifespan)
            ...
            validateattributes(defaultlifespan, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigCarKf', 'DefaultLifespan');
        ...
        function set.NoiseCovariance(obj, noisecovariance)
            ...
            validateattributes(noisecovariance, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigCarKf', 'NoiseCovariance');
        ...
        function set.MeasurementNoiseCovariance(obj, measurementnoisecovariance)
            ...
            validateattributes(measurementnoisecovariance, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigCarKf', 'MeasurementNoiseCovariance');
        ...
        function set.ErrorEstimateCovariance(obj, errorestimatecovariance)
            ...
            validateattributes(errorestimatecovariance, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigCarKf', 'ErrorEstimateCovariance');
        ...
        function set.PercentageOfOverlapping(obj, percentageofoverlapping)
            ...
            validateattributes(percentageofoverlapping, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigCarKf', 'PercentageOfOverlapping');
        ...
        function set.OrbFeatures(obj, orbfeatures)
            ...
            validateattributes(orbfeatures, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigCarKf', 'OrbFeatures');
        ...
        function set.UseOrb(obj, useorb)
            ...
            validateattributes(useorb, {'numeric'}, {'nonempty', 'scalar'}, 'ConfigCarKf', 'UseOrb');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.runtime_manager.ConfigCarKf.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.runtime_manager.ConfigCarKf;
            obj.reload(strObj);
        end
    end
end
